...
import { SharedMapComponent, ViewMapComponent } from '@taqeem-workspace/general-lib';
...
@Component({
  ...
  templateUrl: './add-national-address.component.html',
  styleUrl: './add-national-address.component.scss',
})
export class AddNationalAddressComponent {
  form!: FormGroup;
  options: Option[] = [
    { id: '1', name: 'البيع' },
    { id: '2', name: 'الشراء' },
