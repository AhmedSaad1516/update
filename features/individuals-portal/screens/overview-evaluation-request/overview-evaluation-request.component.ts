...
@Component({
  selector: 'app-overview-evaluation-request',
  templateUrl: './overview-evaluation-request.component.html',
  styleUrls: ['./overview-evaluation-request.component.scss'],
  standalone: true,
  imports: [
...
export class OverviewEvaluationRequestComponent implements OnInit {
  appNumber!: any;
