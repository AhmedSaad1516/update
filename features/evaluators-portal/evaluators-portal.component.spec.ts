...
import { EvaluatorsPortalComponent } from './evaluators-portal.component';
...
describe('EvaluatorsPortal', () => {
  ...
  it('should create the evaluators portal', () => {
    const fixture = TestBed.createComponent(EvaluatorsPortalComponent);
    const app = fixture.componentInstance;
    expect(app).toBeTruthy();
  });
});
