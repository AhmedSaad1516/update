...
import { EvaluatorsRequestInformationComponent } from './evaluators-request-information.component';
...
} from '../../../individuals-portal/data/dummy-test-data';

describe('EvaluatorsRequestInformation', () => {
  let httpClient: HttpClient;
  let httpTestingController: HttpTestingController;
  let fixture: ComponentFixture<EvaluatorsRequestInformationComponent>;
  let component: EvaluatorsRequestInformationComponent;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(EvaluatorsRequestInformationComponent);
  ...
  it('should validate purposeValuationId as required', () => {
    ...
    if (control) {
      ...
      control.setValue(
        valuationRequestInformationList.applicationRequestDTO.purposeValuationId
      );
