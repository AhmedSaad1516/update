...
import { Component, EventEmitter, OnInit, Output ,ViewChild,TemplateRef, ElementRef, AfterViewInit, numberAttribute, Input, Inject} from '@angular/core';
...
@Component({
  selector: 'app-add-image-profile',
  templateUrl: './add-image-profile.component.html',
  styleUrls: ['./add-image-profile.component.scss'],
  standalone: true,
  imports: [
    CommonModule,
    MatIconModule,
...
export class AddImageProfileComponent implements OnInit ,AfterViewInit {
...
constructor(
  ...
  public dialogRef: MatDialogRef<AddImageProfileComponent>,
...
onImageChange(event: any) {
  ...
  const file = event.target.files[0];
 this.data= {  file }
 console.log('datadatadata--data', this.data);
      this.sanitizeImagePreview = this.data.__zone_symbol__value.objectUrl;
